module github.com/0gfoundation/0g-da-client
...
require (
	github.com/0gfoundation/0g-da-client/api v0.0.0
	github.com/0gfoundation/0g-storage-client v0.1.14
...
replace github.com/0gfoundation/0g-da-client/api => ./api
